...
import pt.up.fe.comp2024.analysis.passes.BinExprTypes;
import pt.up.fe.comp2024.analysis.passes.BoolExpr;
...
public class JmmAnalysisImpl implements JmmAnalysis {
    ...
    public JmmAnalysisImpl() {
        ...
        this.analysisPasses = List.of(new UndeclaredVariable(), new BinExprTypes(), new BoolExpr(), new ArrayAccess());
