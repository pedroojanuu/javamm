...
public class OllirExprGeneratorVisitor extends AJmmVisitor<Void, OllirExprResult> {
    ...
    private OllirExprResult visitMethodCallExpr(JmmNode node, Void unused) {
        ...
        OllirExprResult objectVisit = visit(node.getJmmChild(0));
        computation.append(objectVisit.getComputation());
        String objectName = node.getJmmChild(0).getKind().equals(THIS_EXPR.toString()) ? "this" : node.getJmmChild(0).get("id");
        ...
        invoke = objectName.equals("this") ? "invokevirtual" : "invokestatic";
